...
#ifndef PROTOBUF_INCLUDED_simulation_5fconfig_2eproto
#define PROTOBUF_INCLUDED_simulation_5fconfig_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_simulation_5fconfig_2eproto 
...
namespace google {
namespace protobuf {
template<> ::ssl_protos::simulation::RealismConfig* Arena::CreateMaybeMessage<::ssl_protos::simulation::RealismConfig>(Arena*);
template<> ::ssl_protos::simulation::RobotLimits* Arena::CreateMaybeMessage<::ssl_protos::simulation::RobotLimits>(Arena*);
template<> ::ssl_protos::simulation::RobotSpecs* Arena::CreateMaybeMessage<::ssl_protos::simulation::RobotSpecs>(Arena*);
template<> ::ssl_protos::simulation::RobotWheelAngles* Arena::CreateMaybeMessage<::ssl_protos::simulation::RobotWheelAngles>(Arena*);
template<> ::ssl_protos::simulation::SimulatorConfig* Arena::CreateMaybeMessage<::ssl_protos::simulation::SimulatorConfig>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace ssl_protos {
namespace simulation {
...
class RobotLimits : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RobotLimits) */ {
 public:
  RobotLimits();
  virtual ~RobotLimits();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RobotLimits)
 private:
  ...
  friend struct ::protobuf_simulation_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class RobotWheelAngles : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RobotWheelAngles) */ {
 public:
  RobotWheelAngles();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RobotWheelAngles)
 private:
...
class RobotSpecs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RobotSpecs) */ {
 public:
  RobotSpecs();
  virtual ~RobotSpecs();
  ...
  private:
  const ::ssl_protos::simulation::RobotLimits& _internal_limits() const;
  public:
  const ::ssl_protos::simulation::RobotLimits& limits() const;
  ::ssl_protos::simulation::RobotLimits* release_limits();
  ::ssl_protos::simulation::RobotLimits* mutable_limits();
  void set_allocated_limits(::ssl_protos::simulation::RobotLimits* limits);
  ...
  private:
  const ::ssl_protos::simulation::RobotWheelAngles& _internal_wheel_angles() const;
  public:
  const ::ssl_protos::simulation::RobotWheelAngles& wheel_angles() const;
  ::ssl_protos::simulation::RobotWheelAngles* release_wheel_angles();
  ::ssl_protos::simulation::RobotWheelAngles* mutable_wheel_angles();
  void set_allocated_wheel_angles(::ssl_protos::simulation::RobotWheelAngles* wheel_angles);
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RobotSpecs)
 private:
  void set_has_id();
  void clear_has_id();
  void set_has_radius();
  ...
  ::ssl_protos::simulation::RobotLimits* limits_;
  ::ssl_protos::simulation::RobotWheelAngles* wheel_angles_;
  float mass_;
...
class RealismConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RealismConfig) */ {
 public:
  RealismConfig();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RealismConfig)
 private:
...
class SimulatorConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.SimulatorConfig) */ {
 public:
  SimulatorConfig();
  ...
  ::ssl_protos::simulation::RobotSpecs* mutable_robot_specs(int index);
  ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotSpecs >*
      mutable_robot_specs();
  const ::ssl_protos::simulation::RobotSpecs& robot_specs(int index) const;
  ::ssl_protos::simulation::RobotSpecs* add_robot_specs();
  const ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotSpecs >&
      robot_specs() const;
  ...
  private:
  const ::ssl_protos::simulation::RealismConfig& _internal_realism_config() const;
  public:
  const ::ssl_protos::simulation::RealismConfig& realism_config() const;
  ::ssl_protos::simulation::RealismConfig* release_realism_config();
  ::ssl_protos::simulation::RealismConfig* mutable_realism_config();
  void set_allocated_realism_config(::ssl_protos::simulation::RealismConfig* realism_config);
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.SimulatorConfig)
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotSpecs > robot_specs_;
  ::ssl_protos::vision::Geometry* geometry_;
  ::ssl_protos::simulation::RealismConfig* realism_config_;
...
inline float RobotLimits::acc_speedup_absolute_max() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotLimits.acc_speedup_absolute_max)
...
inline void RobotLimits::set_acc_speedup_absolute_max(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotLimits.acc_speedup_absolute_max)
}
...
inline float RobotLimits::acc_speedup_angular_max() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotLimits.acc_speedup_angular_max)
...
inline void RobotLimits::set_acc_speedup_angular_max(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotLimits.acc_speedup_angular_max)
}
...
inline float RobotLimits::acc_brake_absolute_max() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotLimits.acc_brake_absolute_max)
...
inline void RobotLimits::set_acc_brake_absolute_max(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotLimits.acc_brake_absolute_max)
}
...
inline float RobotLimits::acc_brake_angular_max() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotLimits.acc_brake_angular_max)
...
inline void RobotLimits::set_acc_brake_angular_max(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotLimits.acc_brake_angular_max)
}
...
inline float RobotLimits::vel_absolute_max() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotLimits.vel_absolute_max)
...
inline void RobotLimits::set_vel_absolute_max(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotLimits.vel_absolute_max)
}
...
inline float RobotLimits::vel_angular_max() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotLimits.vel_angular_max)
...
inline void RobotLimits::set_vel_angular_max(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotLimits.vel_angular_max)
}
...
inline float RobotWheelAngles::front_right() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotWheelAngles.front_right)
  return front_right_;
}
inline void RobotWheelAngles::set_front_right(float value) {
  set_has_front_right();
  front_right_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotWheelAngles.front_right)
}
...
inline float RobotWheelAngles::back_right() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotWheelAngles.back_right)
  return back_right_;
}
inline void RobotWheelAngles::set_back_right(float value) {
  set_has_back_right();
  back_right_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotWheelAngles.back_right)
}
...
inline float RobotWheelAngles::back_left() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotWheelAngles.back_left)
  return back_left_;
}
inline void RobotWheelAngles::set_back_left(float value) {
  set_has_back_left();
  back_left_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotWheelAngles.back_left)
}
...
inline float RobotWheelAngles::front_left() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotWheelAngles.front_left)
  return front_left_;
}
inline void RobotWheelAngles::set_front_left(float value) {
  set_has_front_left();
  front_left_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotWheelAngles.front_left)
}
...
inline const ::ssl_protos::gc::RobotId& RobotSpecs::_internal_id() const {
  return *id_;
}
inline const ::ssl_protos::gc::RobotId& RobotSpecs::id() const {
  const ::ssl_protos::gc::RobotId* p = id_;
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.id)
  return p != NULL ? *p : *reinterpret_cast<const ::ssl_protos::gc::RobotId*>(
      &::ssl_protos::gc::_RobotId_default_instance_);
}
inline ::ssl_protos::gc::RobotId* RobotSpecs::release_id() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotSpecs.id)
  clear_has_id();
  ::ssl_protos::gc::RobotId* temp = id_;
  id_ = NULL;
  return temp;
}
inline ::ssl_protos::gc::RobotId* RobotSpecs::mutable_id() {
  set_has_id();
  if (id_ == NULL) {
    auto* p = CreateMaybeMessage<::ssl_protos::gc::RobotId>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotSpecs.id)
  return id_;
}
inline void RobotSpecs::set_allocated_id(::ssl_protos::gc::RobotId* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:ssl_protos.simulation.RobotSpecs.id)
}
...
inline float RobotSpecs::radius() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.radius)
  return radius_;
}
inline void RobotSpecs::set_radius(float value) {
  set_has_radius();
  radius_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotSpecs.radius)
}
...
inline float RobotSpecs::height() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.height)
  return height_;
}
inline void RobotSpecs::set_height(float value) {
  set_has_height();
  height_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotSpecs.height)
}
...
inline float RobotSpecs::mass() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.mass)
  return mass_;
}
inline void RobotSpecs::set_mass(float value) {
  set_has_mass();
  mass_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotSpecs.mass)
}
...
inline float RobotSpecs::max_linear_kick_speed() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.max_linear_kick_speed)
...
inline void RobotSpecs::set_max_linear_kick_speed(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotSpecs.max_linear_kick_speed)
}
...
inline float RobotSpecs::max_chip_kick_speed() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.max_chip_kick_speed)
...
inline void RobotSpecs::set_max_chip_kick_speed(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotSpecs.max_chip_kick_speed)
}
...
inline float RobotSpecs::center_to_dribbler() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.center_to_dribbler)
...
inline void RobotSpecs::set_center_to_dribbler(float value) {
  ...
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotSpecs.center_to_dribbler)
}
...
inline const ::ssl_protos::simulation::RobotLimits& RobotSpecs::_internal_limits() const {
  return *limits_;
}
inline const ::ssl_protos::simulation::RobotLimits& RobotSpecs::limits() const {
  const ::ssl_protos::simulation::RobotLimits* p = limits_;
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.limits)
  return p != NULL ? *p : *reinterpret_cast<const ::ssl_protos::simulation::RobotLimits*>(
      &::ssl_protos::simulation::_RobotLimits_default_instance_);
}
inline ::ssl_protos::simulation::RobotLimits* RobotSpecs::release_limits() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotSpecs.limits)
  clear_has_limits();
  ::ssl_protos::simulation::RobotLimits* temp = limits_;
  limits_ = NULL;
  return temp;
}
inline ::ssl_protos::simulation::RobotLimits* RobotSpecs::mutable_limits() {
  set_has_limits();
  if (limits_ == NULL) {
    auto* p = CreateMaybeMessage<::ssl_protos::simulation::RobotLimits>(GetArenaNoVirtual());
    limits_ = p;
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotSpecs.limits)
  return limits_;
}
inline void RobotSpecs::set_allocated_limits(::ssl_protos::simulation::RobotLimits* limits) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete limits_;
  }
  ...
  limits_ = limits;
  // @@protoc_insertion_point(field_set_allocated:ssl_protos.simulation.RobotSpecs.limits)
}
...
inline const ::ssl_protos::simulation::RobotWheelAngles& RobotSpecs::_internal_wheel_angles() const {
  return *wheel_angles_;
}
inline const ::ssl_protos::simulation::RobotWheelAngles& RobotSpecs::wheel_angles() const {
  const ::ssl_protos::simulation::RobotWheelAngles* p = wheel_angles_;
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.wheel_angles)
  return p != NULL ? *p : *reinterpret_cast<const ::ssl_protos::simulation::RobotWheelAngles*>(
      &::ssl_protos::simulation::_RobotWheelAngles_default_instance_);
}
inline ::ssl_protos::simulation::RobotWheelAngles* RobotSpecs::release_wheel_angles() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotSpecs.wheel_angles)
  clear_has_wheel_angles();
  ::ssl_protos::simulation::RobotWheelAngles* temp = wheel_angles_;
  wheel_angles_ = NULL;
  return temp;
}
inline ::ssl_protos::simulation::RobotWheelAngles* RobotSpecs::mutable_wheel_angles() {
  set_has_wheel_angles();
  if (wheel_angles_ == NULL) {
    auto* p = CreateMaybeMessage<::ssl_protos::simulation::RobotWheelAngles>(GetArenaNoVirtual());
    wheel_angles_ = p;
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotSpecs.wheel_angles)
  return wheel_angles_;
}
inline void RobotSpecs::set_allocated_wheel_angles(::ssl_protos::simulation::RobotWheelAngles* wheel_angles) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ssl_protos.simulation.RobotSpecs.wheel_angles)
}
...
inline ::google::protobuf::Any* RobotSpecs::mutable_custom(int index) {
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotSpecs.custom)
  return custom_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Any >*
RobotSpecs::mutable_custom() {
  // @@protoc_insertion_point(field_mutable_list:ssl_protos.simulation.RobotSpecs.custom)
  return &custom_;
}
inline const ::google::protobuf::Any& RobotSpecs::custom(int index) const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotSpecs.custom)
  return custom_.Get(index);
}
inline ::google::protobuf::Any* RobotSpecs::add_custom() {
  // @@protoc_insertion_point(field_add:ssl_protos.simulation.RobotSpecs.custom)
  return custom_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Any >&
RobotSpecs::custom() const {
  // @@protoc_insertion_point(field_list:ssl_protos.simulation.RobotSpecs.custom)
  return custom_;
}
...
inline ::google::protobuf::Any* RealismConfig::mutable_custom(int index) {
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RealismConfig.custom)
  return custom_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Any >*
RealismConfig::mutable_custom() {
  // @@protoc_insertion_point(field_mutable_list:ssl_protos.simulation.RealismConfig.custom)
  return &custom_;
}
inline const ::google::protobuf::Any& RealismConfig::custom(int index) const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RealismConfig.custom)
  return custom_.Get(index);
}
inline ::google::protobuf::Any* RealismConfig::add_custom() {
  // @@protoc_insertion_point(field_add:ssl_protos.simulation.RealismConfig.custom)
  return custom_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Any >&
RealismConfig::custom() const {
  // @@protoc_insertion_point(field_list:ssl_protos.simulation.RealismConfig.custom)
  return custom_;
}
...
inline const ::ssl_protos::vision::Geometry& SimulatorConfig::_internal_geometry() const {
  return *geometry_;
}
inline const ::ssl_protos::vision::Geometry& SimulatorConfig::geometry() const {
  const ::ssl_protos::vision::Geometry* p = geometry_;
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.SimulatorConfig.geometry)
  return p != NULL ? *p : *reinterpret_cast<const ::ssl_protos::vision::Geometry*>(
      &::ssl_protos::vision::_Geometry_default_instance_);
}
inline ::ssl_protos::vision::Geometry* SimulatorConfig::release_geometry() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.SimulatorConfig.geometry)
  clear_has_geometry();
  ::ssl_protos::vision::Geometry* temp = geometry_;
  geometry_ = NULL;
  return temp;
}
inline ::ssl_protos::vision::Geometry* SimulatorConfig::mutable_geometry() {
  set_has_geometry();
  if (geometry_ == NULL) {
    auto* p = CreateMaybeMessage<::ssl_protos::vision::Geometry>(GetArenaNoVirtual());
    geometry_ = p;
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.SimulatorConfig.geometry)
  return geometry_;
}
inline void SimulatorConfig::set_allocated_geometry(::ssl_protos::vision::Geometry* geometry) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  geometry_ = geometry;
  // @@protoc_insertion_point(field_set_allocated:ssl_protos.simulation.SimulatorConfig.geometry)
}
...
inline ::ssl_protos::simulation::RobotSpecs* SimulatorConfig::mutable_robot_specs(int index) {
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.SimulatorConfig.robot_specs)
  return robot_specs_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotSpecs >*
SimulatorConfig::mutable_robot_specs() {
  // @@protoc_insertion_point(field_mutable_list:ssl_protos.simulation.SimulatorConfig.robot_specs)
  return &robot_specs_;
}
inline const ::ssl_protos::simulation::RobotSpecs& SimulatorConfig::robot_specs(int index) const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.SimulatorConfig.robot_specs)
  return robot_specs_.Get(index);
}
inline ::ssl_protos::simulation::RobotSpecs* SimulatorConfig::add_robot_specs() {
  // @@protoc_insertion_point(field_add:ssl_protos.simulation.SimulatorConfig.robot_specs)
  return robot_specs_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotSpecs >&
SimulatorConfig::robot_specs() const {
  // @@protoc_insertion_point(field_list:ssl_protos.simulation.SimulatorConfig.robot_specs)
  return robot_specs_;
}
...
inline const ::ssl_protos::simulation::RealismConfig& SimulatorConfig::_internal_realism_config() const {
  return *realism_config_;
}
inline const ::ssl_protos::simulation::RealismConfig& SimulatorConfig::realism_config() const {
  const ::ssl_protos::simulation::RealismConfig* p = realism_config_;
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.SimulatorConfig.realism_config)
  return p != NULL ? *p : *reinterpret_cast<const ::ssl_protos::simulation::RealismConfig*>(
      &::ssl_protos::simulation::_RealismConfig_default_instance_);
}
inline ::ssl_protos::simulation::RealismConfig* SimulatorConfig::release_realism_config() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.SimulatorConfig.realism_config)
  clear_has_realism_config();
  ::ssl_protos::simulation::RealismConfig* temp = realism_config_;
  realism_config_ = NULL;
  return temp;
}
inline ::ssl_protos::simulation::RealismConfig* SimulatorConfig::mutable_realism_config() {
  set_has_realism_config();
  if (realism_config_ == NULL) {
    auto* p = CreateMaybeMessage<::ssl_protos::simulation::RealismConfig>(GetArenaNoVirtual());
    realism_config_ = p;
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.SimulatorConfig.realism_config)
  return realism_config_;
}
inline void SimulatorConfig::set_allocated_realism_config(::ssl_protos::simulation::RealismConfig* realism_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ssl_protos.simulation.SimulatorConfig.realism_config)
}
...
inline ::google::protobuf::uint32 SimulatorConfig::vision_port() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.SimulatorConfig.vision_port)
  return vision_port_;
}
inline void SimulatorConfig::set_vision_port(::google::protobuf::uint32 value) {
  set_has_vision_port();
  vision_port_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.SimulatorConfig.vision_port)
}
...
#endif  // PROTOBUF_INCLUDED_simulation_5fconfig_2eproto
