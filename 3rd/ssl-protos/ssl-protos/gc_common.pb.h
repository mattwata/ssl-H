...
#ifndef PROTOBUF_INCLUDED_gc_5fcommon_2eproto
#define PROTOBUF_INCLUDED_gc_5fcommon_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_gc_5fcommon_2eproto 
...
namespace google {
namespace protobuf {
template<> ::ssl_protos::gc::RobotId* Arena::CreateMaybeMessage<::ssl_protos::gc::RobotId>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace ssl_protos {
namespace gc {
...
class RobotId : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.gc.RobotId) */ {
 public:
  RobotId();
  virtual ~RobotId();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.gc.RobotId)
 private:
  void set_has_id();
  void clear_has_id();
  void set_has_team();
  ...
  int team_;
  friend struct ::protobuf_gc_5fcommon_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::uint32 RobotId::id() const {
  // @@protoc_insertion_point(field_get:ssl_protos.gc.RobotId.id)
  return id_;
}
inline void RobotId::set_id(::google::protobuf::uint32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.gc.RobotId.id)
}
...
inline ::ssl_protos::gc::Team RobotId::team() const {
  // @@protoc_insertion_point(field_get:ssl_protos.gc.RobotId.team)
  return static_cast< ::ssl_protos::gc::Team >(team_);
}
inline void RobotId::set_team(::ssl_protos::gc::Team value) {
  assert(::ssl_protos::gc::Team_IsValid(value));
  set_has_team();
  team_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.gc.RobotId.team)
}
...
template <> struct is_proto_enum< ::ssl_protos::gc::Team> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ssl_protos::gc::Team>() {
  return ::ssl_protos::gc::Team_descriptor();
}
template <> struct is_proto_enum< ::ssl_protos::gc::Division> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ssl_protos::gc::Division>() {
  return ::ssl_protos::gc::Division_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_gc_5fcommon_2eproto
