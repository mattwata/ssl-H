...
#ifndef PROTOBUF_INCLUDED_simulation_5frobot_5fcontrol_2eproto
#define PROTOBUF_INCLUDED_simulation_5frobot_5fcontrol_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_simulation_5frobot_5fcontrol_2eproto 
...
namespace google {
namespace protobuf {
template<> ::ssl_protos::simulation::MoveGlobalVelocity* Arena::CreateMaybeMessage<::ssl_protos::simulation::MoveGlobalVelocity>(Arena*);
template<> ::ssl_protos::simulation::MoveLocalVelocity* Arena::CreateMaybeMessage<::ssl_protos::simulation::MoveLocalVelocity>(Arena*);
template<> ::ssl_protos::simulation::MoveWheelVelocity* Arena::CreateMaybeMessage<::ssl_protos::simulation::MoveWheelVelocity>(Arena*);
template<> ::ssl_protos::simulation::RobotCommand* Arena::CreateMaybeMessage<::ssl_protos::simulation::RobotCommand>(Arena*);
template<> ::ssl_protos::simulation::RobotControl* Arena::CreateMaybeMessage<::ssl_protos::simulation::RobotControl>(Arena*);
template<> ::ssl_protos::simulation::RobotMoveCommand* Arena::CreateMaybeMessage<::ssl_protos::simulation::RobotMoveCommand>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace ssl_protos {
namespace simulation {
...
class RobotCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RobotCommand) */ {
 public:
  RobotCommand();
  ...
  private:
  const ::ssl_protos::simulation::RobotMoveCommand& _internal_move_command() const;
  public:
  const ::ssl_protos::simulation::RobotMoveCommand& move_command() const;
  ::ssl_protos::simulation::RobotMoveCommand* release_move_command();
  ::ssl_protos::simulation::RobotMoveCommand* mutable_move_command();
  void set_allocated_move_command(::ssl_protos::simulation::RobotMoveCommand* move_command);
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RobotCommand)
 private:
  void set_has_id();
  void clear_has_id();
  ...
  ::ssl_protos::simulation::RobotMoveCommand* move_command_;
  ::google::protobuf::uint32 id_;
  float kick_speed_;
  float kick_angle_;
  float dribbler_speed_;
  friend struct ::protobuf_simulation_5frobot_5fcontrol_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class RobotMoveCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RobotMoveCommand) */ {
 public:
  RobotMoveCommand();
  ...
  private:
  const ::ssl_protos::simulation::MoveWheelVelocity& _internal_wheel_velocity() const;
  public:
  const ::ssl_protos::simulation::MoveWheelVelocity& wheel_velocity() const;
  ::ssl_protos::simulation::MoveWheelVelocity* release_wheel_velocity();
  ::ssl_protos::simulation::MoveWheelVelocity* mutable_wheel_velocity();
  void set_allocated_wheel_velocity(::ssl_protos::simulation::MoveWheelVelocity* wheel_velocity);
  ...
  private:
  const ::ssl_protos::simulation::MoveLocalVelocity& _internal_local_velocity() const;
  public:
  const ::ssl_protos::simulation::MoveLocalVelocity& local_velocity() const;
  ::ssl_protos::simulation::MoveLocalVelocity* release_local_velocity();
  ::ssl_protos::simulation::MoveLocalVelocity* mutable_local_velocity();
  void set_allocated_local_velocity(::ssl_protos::simulation::MoveLocalVelocity* local_velocity);
  ...
  private:
  const ::ssl_protos::simulation::MoveGlobalVelocity& _internal_global_velocity() const;
  public:
  const ::ssl_protos::simulation::MoveGlobalVelocity& global_velocity() const;
  ::ssl_protos::simulation::MoveGlobalVelocity* release_global_velocity();
  ::ssl_protos::simulation::MoveGlobalVelocity* mutable_global_velocity();
  void set_allocated_global_velocity(::ssl_protos::simulation::MoveGlobalVelocity* global_velocity);

  void clear_command();
  CommandCase command_case() const;
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RobotMoveCommand)
 private:
  ...
  union CommandUnion {
    CommandUnion() {}
    ::ssl_protos::simulation::MoveWheelVelocity* wheel_velocity_;
    ::ssl_protos::simulation::MoveLocalVelocity* local_velocity_;
    ::ssl_protos::simulation::MoveGlobalVelocity* global_velocity_;
  } command_;
...
class MoveWheelVelocity : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.MoveWheelVelocity) */ {
 public:
  MoveWheelVelocity();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.MoveWheelVelocity)
 private:
...
class MoveLocalVelocity : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.MoveLocalVelocity) */ {
 public:
  MoveLocalVelocity();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.MoveLocalVelocity)
 private:
...
class MoveGlobalVelocity : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.MoveGlobalVelocity) */ {
 public:
  MoveGlobalVelocity();
  ...
  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.MoveGlobalVelocity)
 private:
  void set_has_x();
  void clear_has_x();
  void set_has_y();
...
class RobotControl : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssl_protos.simulation.RobotControl) */ {
 public:
  RobotControl();
  ...
  ::ssl_protos::simulation::RobotCommand* mutable_robot_commands(int index);
  ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotCommand >*
      mutable_robot_commands();
  const ::ssl_protos::simulation::RobotCommand& robot_commands(int index) const;
  ::ssl_protos::simulation::RobotCommand* add_robot_commands();
  const ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotCommand >&
      robot_commands() const;

  // @@protoc_insertion_point(class_scope:ssl_protos.simulation.RobotControl)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotCommand > robot_commands_;
  friend struct ::protobuf_simulation_5frobot_5fcontrol_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::uint32 RobotCommand::id() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotCommand.id)
  return id_;
}
inline void RobotCommand::set_id(::google::protobuf::uint32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotCommand.id)
}
...
inline const ::ssl_protos::simulation::RobotMoveCommand& RobotCommand::_internal_move_command() const {
  return *move_command_;
}
inline const ::ssl_protos::simulation::RobotMoveCommand& RobotCommand::move_command() const {
  const ::ssl_protos::simulation::RobotMoveCommand* p = move_command_;
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotCommand.move_command)
  return p != NULL ? *p : *reinterpret_cast<const ::ssl_protos::simulation::RobotMoveCommand*>(
      &::ssl_protos::simulation::_RobotMoveCommand_default_instance_);
}
inline ::ssl_protos::simulation::RobotMoveCommand* RobotCommand::release_move_command() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotCommand.move_command)
  clear_has_move_command();
  ::ssl_protos::simulation::RobotMoveCommand* temp = move_command_;
  move_command_ = NULL;
  return temp;
}
inline ::ssl_protos::simulation::RobotMoveCommand* RobotCommand::mutable_move_command() {
  set_has_move_command();
  if (move_command_ == NULL) {
    auto* p = CreateMaybeMessage<::ssl_protos::simulation::RobotMoveCommand>(GetArenaNoVirtual());
    move_command_ = p;
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotCommand.move_command)
  return move_command_;
}
inline void RobotCommand::set_allocated_move_command(::ssl_protos::simulation::RobotMoveCommand* move_command) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ssl_protos.simulation.RobotCommand.move_command)
}
...
inline float RobotCommand::kick_speed() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotCommand.kick_speed)
  return kick_speed_;
}
inline void RobotCommand::set_kick_speed(float value) {
  set_has_kick_speed();
  kick_speed_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotCommand.kick_speed)
}
...
inline float RobotCommand::kick_angle() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotCommand.kick_angle)
  return kick_angle_;
}
inline void RobotCommand::set_kick_angle(float value) {
  set_has_kick_angle();
  kick_angle_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotCommand.kick_angle)
}
...
inline float RobotCommand::dribbler_speed() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotCommand.dribbler_speed)
  return dribbler_speed_;
}
inline void RobotCommand::set_dribbler_speed(float value) {
  set_has_dribbler_speed();
  dribbler_speed_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.RobotCommand.dribbler_speed)
}
...
inline const ::ssl_protos::simulation::MoveWheelVelocity& RobotMoveCommand::_internal_wheel_velocity() const {
  return *command_.wheel_velocity_;
}
inline ::ssl_protos::simulation::MoveWheelVelocity* RobotMoveCommand::release_wheel_velocity() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotMoveCommand.wheel_velocity)
  if (has_wheel_velocity()) {
    clear_has_command();
      ::ssl_protos::simulation::MoveWheelVelocity* temp = command_.wheel_velocity_;
...
inline const ::ssl_protos::simulation::MoveWheelVelocity& RobotMoveCommand::wheel_velocity() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotMoveCommand.wheel_velocity)
  return has_wheel_velocity()
      ? *command_.wheel_velocity_
      : *reinterpret_cast< ::ssl_protos::simulation::MoveWheelVelocity*>(&::ssl_protos::simulation::_MoveWheelVelocity_default_instance_);
}
inline ::ssl_protos::simulation::MoveWheelVelocity* RobotMoveCommand::mutable_wheel_velocity() {
  if (!has_wheel_velocity()) {
    clear_command();
    set_has_wheel_velocity();
    command_.wheel_velocity_ = CreateMaybeMessage< ::ssl_protos::simulation::MoveWheelVelocity >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotMoveCommand.wheel_velocity)
  return command_.wheel_velocity_;
}
...
inline const ::ssl_protos::simulation::MoveLocalVelocity& RobotMoveCommand::_internal_local_velocity() const {
  return *command_.local_velocity_;
}
inline ::ssl_protos::simulation::MoveLocalVelocity* RobotMoveCommand::release_local_velocity() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotMoveCommand.local_velocity)
  if (has_local_velocity()) {
    clear_has_command();
      ::ssl_protos::simulation::MoveLocalVelocity* temp = command_.local_velocity_;
...
inline const ::ssl_protos::simulation::MoveLocalVelocity& RobotMoveCommand::local_velocity() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotMoveCommand.local_velocity)
  return has_local_velocity()
      ? *command_.local_velocity_
      : *reinterpret_cast< ::ssl_protos::simulation::MoveLocalVelocity*>(&::ssl_protos::simulation::_MoveLocalVelocity_default_instance_);
}
inline ::ssl_protos::simulation::MoveLocalVelocity* RobotMoveCommand::mutable_local_velocity() {
  if (!has_local_velocity()) {
    clear_command();
    set_has_local_velocity();
    command_.local_velocity_ = CreateMaybeMessage< ::ssl_protos::simulation::MoveLocalVelocity >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotMoveCommand.local_velocity)
  return command_.local_velocity_;
}
...
inline const ::ssl_protos::simulation::MoveGlobalVelocity& RobotMoveCommand::_internal_global_velocity() const {
  return *command_.global_velocity_;
}
inline ::ssl_protos::simulation::MoveGlobalVelocity* RobotMoveCommand::release_global_velocity() {
  // @@protoc_insertion_point(field_release:ssl_protos.simulation.RobotMoveCommand.global_velocity)
  if (has_global_velocity()) {
    clear_has_command();
      ::ssl_protos::simulation::MoveGlobalVelocity* temp = command_.global_velocity_;
...
inline const ::ssl_protos::simulation::MoveGlobalVelocity& RobotMoveCommand::global_velocity() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotMoveCommand.global_velocity)
  return has_global_velocity()
      ? *command_.global_velocity_
      : *reinterpret_cast< ::ssl_protos::simulation::MoveGlobalVelocity*>(&::ssl_protos::simulation::_MoveGlobalVelocity_default_instance_);
}
inline ::ssl_protos::simulation::MoveGlobalVelocity* RobotMoveCommand::mutable_global_velocity() {
  if (!has_global_velocity()) {
    clear_command();
    set_has_global_velocity();
    command_.global_velocity_ = CreateMaybeMessage< ::ssl_protos::simulation::MoveGlobalVelocity >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotMoveCommand.global_velocity)
  return command_.global_velocity_;
}
...
inline float MoveWheelVelocity::front_right() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveWheelVelocity.front_right)
  return front_right_;
}
inline void MoveWheelVelocity::set_front_right(float value) {
  set_has_front_right();
  front_right_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveWheelVelocity.front_right)
}
...
inline float MoveWheelVelocity::back_right() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveWheelVelocity.back_right)
  return back_right_;
}
inline void MoveWheelVelocity::set_back_right(float value) {
  set_has_back_right();
  back_right_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveWheelVelocity.back_right)
}
...
inline float MoveWheelVelocity::back_left() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveWheelVelocity.back_left)
  return back_left_;
}
inline void MoveWheelVelocity::set_back_left(float value) {
  set_has_back_left();
  back_left_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveWheelVelocity.back_left)
}
...
inline float MoveWheelVelocity::front_left() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveWheelVelocity.front_left)
  return front_left_;
}
inline void MoveWheelVelocity::set_front_left(float value) {
  set_has_front_left();
  front_left_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveWheelVelocity.front_left)
}
...
inline float MoveLocalVelocity::forward() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveLocalVelocity.forward)
  return forward_;
}
inline void MoveLocalVelocity::set_forward(float value) {
  set_has_forward();
  forward_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveLocalVelocity.forward)
}
...
inline float MoveLocalVelocity::left() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveLocalVelocity.left)
  return left_;
}
inline void MoveLocalVelocity::set_left(float value) {
  set_has_left();
  left_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveLocalVelocity.left)
}
...
inline float MoveLocalVelocity::angular() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveLocalVelocity.angular)
  return angular_;
}
inline void MoveLocalVelocity::set_angular(float value) {
  set_has_angular();
  angular_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveLocalVelocity.angular)
}
...
inline float MoveGlobalVelocity::x() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveGlobalVelocity.x)
  return x_;
}
inline void MoveGlobalVelocity::set_x(float value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveGlobalVelocity.x)
}
...
inline float MoveGlobalVelocity::y() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveGlobalVelocity.y)
  return y_;
}
inline void MoveGlobalVelocity::set_y(float value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveGlobalVelocity.y)
}
...
inline float MoveGlobalVelocity::angular() const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.MoveGlobalVelocity.angular)
  return angular_;
}
inline void MoveGlobalVelocity::set_angular(float value) {
  set_has_angular();
  angular_ = value;
  // @@protoc_insertion_point(field_set:ssl_protos.simulation.MoveGlobalVelocity.angular)
}
...
inline ::ssl_protos::simulation::RobotCommand* RobotControl::mutable_robot_commands(int index) {
  // @@protoc_insertion_point(field_mutable:ssl_protos.simulation.RobotControl.robot_commands)
  return robot_commands_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotCommand >*
RobotControl::mutable_robot_commands() {
  // @@protoc_insertion_point(field_mutable_list:ssl_protos.simulation.RobotControl.robot_commands)
  return &robot_commands_;
}
inline const ::ssl_protos::simulation::RobotCommand& RobotControl::robot_commands(int index) const {
  // @@protoc_insertion_point(field_get:ssl_protos.simulation.RobotControl.robot_commands)
  return robot_commands_.Get(index);
}
inline ::ssl_protos::simulation::RobotCommand* RobotControl::add_robot_commands() {
  // @@protoc_insertion_point(field_add:ssl_protos.simulation.RobotControl.robot_commands)
  return robot_commands_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::ssl_protos::simulation::RobotCommand >&
RobotControl::robot_commands() const {
  // @@protoc_insertion_point(field_list:ssl_protos.simulation.RobotControl.robot_commands)
  return robot_commands_;
}
...
#endif  // PROTOBUF_INCLUDED_simulation_5frobot_5fcontrol_2eproto
